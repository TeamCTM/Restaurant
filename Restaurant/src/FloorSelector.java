...
public class FloorSelector {
  ...
  static Icon fiveIcon = new ImageIcon("tile.png");
  ...
  public static void main(String args[]) {
    ...
    JMenu menu = new JMenu("Floor Selector");
    ...
    JRadioButtonMenuItem fiveMenuItem = new JRadioButtonMenuItem("Tile",fiveIcon,true);
